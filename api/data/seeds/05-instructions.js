  ...
  return knex('instructions').del()
    .then(function () {
      ...
      return knex('instructions').insert([
          ...
          {
            step_number: 1,
            step_instructions: "Spread mayonnaise and mustard on both sides of bread",
            recipe_id: 4,
          },
          {
            step_number: 2,
            step_instructions: "Add protein, cheese, lettuce, and onions",
            recipe_id: 4,
          },
          {
            step_number: 1,
          ...
          {
            step_number: 2,
            step_instructions: "Add protein of your choice, black beans, and cheese",
            recipe_id: 6,
          },
          {
            step_number: 3,
          ...
          {
            step_number: 1,
            step_instructions: "Cut and enjoy",
            recipe_id: 7,
          },
          {
            step_number: 1,
            step_instructions: "Open and pour into glass with ice. Enjoy",
            recipe_id: 8,
          },
          {
            step_number: 1,
          ...
          { step_number: 2, step_instructions: "Unwrap and eat", recipe_id: 9 },
          {
            step_number: 1,
